  ...
  \twocolumn[
    		\begin{@twocolumnfalse}
    			\vspace{0.78cm}
      			\begin{center}
  				{\LARGE
  					Typografie a publikování -- 1. projekt \\[0.75cm]
  				}
  				{\large
            Filip Pospíšil (\texttt{xpospi0f@stud.fit.vutbr.cz})
  				}
  			\end{center}
  			\vspace{0.6cm}
    		\end{@twocolumnfalse}
...
\section{Smíšená sazba}
  ...
  \begin{adjustwidth}{0.77cm}{0.8cm}
    \medskip
      Čím více \textbf{druhů}, \emph{řezů}, {\scriptsize velikostí}, barev písma a jiných {\tiny \textbf{efektů}} použijeme, tím \emph{profesionálněji} bude dokument vypadat. {\smallČtenář tím} {\large bude} {\Large vždy} {\huge NADŠEN!}
    \medskip
  \end{adjustwidth}
